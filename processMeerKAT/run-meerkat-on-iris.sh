...
singularity exec --cleanenv -H $PWD -B cal_scripts/ -B data/1491550051.ms/ casameer-5.4.1.xvfb.simg mpicasa -n 17 casa -c cal_scripts/quick_tclean.py --config myconfig.txt
time 
